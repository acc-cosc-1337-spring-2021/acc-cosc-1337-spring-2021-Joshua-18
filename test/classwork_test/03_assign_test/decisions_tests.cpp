...
TEST_CASE("Verify argument value using if statements", "it should return correct letter grade")
{
...
TEST_CASE("Verify argument value using switch case", "it should return correct letter grade")
{
