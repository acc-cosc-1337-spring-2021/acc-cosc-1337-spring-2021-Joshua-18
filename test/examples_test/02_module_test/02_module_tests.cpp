...
the decimal portion*/
TEST_CASE("Test convert to double to int", "double to int, truncate decomals")
{
...
decimal portion*/
TEST_CASE("Test static cast double to int", "explicit double to int, truncate decomals")
{
